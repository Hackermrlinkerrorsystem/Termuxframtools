...
echo
toilet -f term -F gay =============================================
echo "$a Termux-New-Look $b Create $c by $d AingCuy"
toilet -f term -F gay =============================================
echo
echo
...
echo 
echo "$a My github link$d :-$e http://github.com/Hackermrlinkerrorsystem"
echo
echo "$a This Tool Github Link$f :-$e http://github.com/rooted-cyber/TermuxframTools"
echo
